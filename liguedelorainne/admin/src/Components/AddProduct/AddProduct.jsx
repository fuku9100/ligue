...
const AddProduct = () => {
  ...
  return (
    <div className="addproduct">
      ...
      <div className="addproduct-itemfield">
        <p>Stock</p>
        <input type="text" name="stock" value={productDetails.stock} onChange={(e)=>{changeHandler(e)}} placeholder="Type here" />
      </div>
      <div className="addproduct-itemfield">
        <p>Product category</p>
        <select value={productDetails.category} name="category" className="add-product-selector" onChange={changeHandler}>
          <option value="women">Accessoires</option>
          <option value="men">Vetement</option>
          <option value="kid">Objet</option>
        </select> 
      </div>
      <div className="addproduct-itemfield">
        <p>Product Image</p>
